...
@Disabled
@TeleOp(name = "Easy CV Internal Cam Test")
public class EasyCVInternalCamTest extends OpMode {
    ...
    public void init() {
        ...
        /*
         * Tell the camera to star  t streaming images to us! Note that you must make sure
